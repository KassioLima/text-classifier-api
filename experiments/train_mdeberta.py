...
def parse_args():
    parser = argparse.ArgumentParser(description="Treino baseline com microsoft/mdeberta-v3-base para tipo/produto/assunto.")
...
def merge_summary(summary_path: Path, current_results: list[dict]) -> list[dict]:
    ...
    # Inclui qualquer tarefa extra fora da ordem padrão.
